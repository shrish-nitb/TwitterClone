...
func (tu *TweetUpdate) SetUser(s string) *TweetUpdate {
	tu.mutation.SetUser(s)
	return tu
}

// SetNillableUser sets the "user" field if the given value is not nil.
func (tu *TweetUpdate) SetNillableUser(s *string) *TweetUpdate {
	if s != nil {
		tu.SetUser(*s)
	}
	return tu
...
func (tu *TweetUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.User(); ok {
		_spec.SetField(tweet.FieldUser, field.TypeString, value)
	}
...
// SetUser sets the "user" field.
func (tuo *TweetUpdateOne) SetUser(s string) *TweetUpdateOne {
	tuo.mutation.SetUser(s)
	return tuo
}

// SetNillableUser sets the "user" field if the given value is not nil.
func (tuo *TweetUpdateOne) SetNillableUser(s *string) *TweetUpdateOne {
	if s != nil {
		tuo.SetUser(*s)
	}
	return tuo
